...
class SumEval:
    ...
    def score_faithfulness(
        ...
        src_statements = self.tokenizer.sentencize(source)
        logger.debug(f"Source statements: {len(src_statements)}")
        summ_statements = self.tokenizer.sentencize(summary)
    ...
    def score(
            ...
            conciseness_threshold: float=0.9
            ) -> Dict:
